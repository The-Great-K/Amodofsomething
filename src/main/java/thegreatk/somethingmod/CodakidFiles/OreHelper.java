...
public class OreHelper {
	...
	public static void silverOreGeneration(final BiomeLoadingEvent event, RuleTest rule, BlockState state,
			String registryName, int veinSize, int minHeight, int maxHeight, int amount) {
		OreConfiguration overworldSilverConfig = new OreConfiguration(rule, state, veinSize);
		OVERWORLD_SILVER_GEN = registerPlacedOreFeature(registryName,
				new ConfiguredFeature<>(Feature.ORE, overworldSilverConfig), CountPlacement.of(amount),
	...
	private static <C extends FeatureConfiguration, F extends Feature<C>> Holder<PlacedFeature> registerPlacedOreFeature(
